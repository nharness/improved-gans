...
flags.DEFINE_integer("train_size", 512, "The size of train images [np.inf]")
...
flags.DEFINE_string("dataset", "patents", "The name of dataset [celebA, mnist, lsun]")
...
def main(_):
    ...
    with tf.Session(config=tf.ConfigProto(
        ...
        dcgan = DCGAN(sess, image_size=FLAGS.image_size, batch_size=FLAGS.batch_size,
                    ...
                    out_stddev = .075,
                    out_init_b = - .45,
                    image_shape=[FLAGS.image_width, FLAGS.image_width],
